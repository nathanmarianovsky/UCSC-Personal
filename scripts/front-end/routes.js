			...
			$.get("/client/content.html").done(data => {
			    ...
			    for(var j = 0; j < 17; j++) {
				    ...
				    for(i = 15 * j; i <= 15 * (j + 1); i++) {
					    ...
					    num++;
					    pow = num/denom;
					    // if(i == (15 * j) + 3 && j >= 2 && j <= 10) {
					    // 	var obj = {
					    // 		"angle": -angle,
					    // 		"radius": Math.pow(angle, pow) * (2 * angle)
					    // 	};
					    // 	hexPos.push(obj);
					    // }
				    }
			    ...
			    // var obj = {
		    	// 	"angle": -10.5,
		    	// 	"radius": Math.pow(100, pow) * (2 * 100)
		    	// };
		    	hexPos = [
		    		{ "angle": -3.3, "radius": Math.pow(3.3, pow) * (2 * 3.3) },
		    		{ "angle": -5, "radius": Math.pow(4, pow) * (2 * 4) },
		    		{ "angle": -6.6, "radius": Math.pow(4.7, pow) * (2 * 4.7) },
		    		{ "angle": -8, "radius": Math.pow(5.4, pow) * (2 * 5.4) },
		    		{ "angle": -9.2, "radius": Math.pow(6.2, pow) * (2 * 6.2) },
		    		{ "angle": -10.5, "radius": Math.pow(7.2, pow) * (2 * 7.2) },
		    		{ "angle": -11.5, "radius": Math.pow(8, pow) * (2 * 8) },
		    		{ "angle": -12.5, "radius": Math.pow(8.5, pow) * (2 * 8.5) },
		    		{ "angle": -13.4, "radius": Math.pow(9.2, pow) * (2 * 9.2) },
		    		{ "angle": -14.2, "radius": Math.pow(10, pow) * (2 * 10) },
		    		{ "angle": -15, "radius": Math.pow(10.6, pow) * (2 * 10.6) },
		    		{ "angle": -16, "radius": Math.pow(11.7, pow) * (2 * 11.7) },
		    		{ "angle": -16.8, "radius": Math.pow(13, pow) * (2 * 13) },
		    		{ "angle": -17.6, "radius": Math.pow(14, pow) * (2 * 14) },
		    		{ "angle": -18.4, "radius": Math.pow(15, pow) * (2 * 15) },
		    		{ "angle": -19.3, "radius": Math.pow(15.8, pow) * (2 * 15.8) },
		    		{ "angle": -20.5, "radius": Math.pow(17.3, pow) * (2 * 17.3) },
		    		{ "angle": -21.6, "radius": Math.pow(19, pow) * (2 * 19) }
		    	];
			    ...
			    if(denom != 370) {
			    	sizeArr = sizeArr.map(elem => elem - ((elem * .25) / 50) * (denom - 370));
			    }
				...
				for(var i = 0; i < hexPos.length; i++) {
					var img = $("<img>").attr({
							...
							"position": "absolute",
							"width": (sizeArr[i]) + "px",
							"left": ((centerx + ((hexPos[i].radius * alpha) * Math.cos(hexPos[i].angle))) - (sizeArr[i]) / 2) + "px",
							"top": ((42 + centery + ((hexPos[i].radius * alpha) * Math.sin(hexPos[i].angle))) - (sizeArr[i] * sizeFix) / 2) + "px",
							"z-index": 1
						}).hide();
				...
				$("main").append(div);
				// div.append(collection[0]);
				// collection[0].show("slow");
